...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="Erx6Ph6DhuNxlfMabtzb.AhPgjPQeExZkbn9kdJiY2W.WQ13VHBa1bTenoyf7r6sfI+woUN8a5ydlEfsUm/BiFc=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
...
admin = ["ub4d829c38a9bcc4bf125fbd2a4167119"]
owner = ["ub4d829c38a9bcc4bf125fbd2a4167119"]
wait = {
    "alwayRead":False,
    "detectMention":True,
    'potoMention':False,
